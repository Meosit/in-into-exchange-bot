...
object Currencies : Iterable<Currency> {
    ...
    private val ALL = mapOf(
        "USD" to Currency(code = "USD", emoji = "🇺🇸",                       aliases = arrayOf("$", "dollar", "bucks", "бакс", "доллар", "USA", "США")),
        "EUR" to Currency(code = "EUR", emoji = "🇪🇺",                       aliases = arrayOf("€", "euro", "евро", "European", "Евросоюз")),
        "BYN" to Currency(code = "BYN", emoji = "🇧🇾",                       aliases = arrayOf("br", "бун", "бур", "бр", "BYR", "Belarus", "Беларусь")),
        "RUB" to Currency(code = "RUB", emoji = "🇷🇺",                       aliases = arrayOf("₽", "rouble", "рубль", "RUR", "Russia", "Россия")),
        "UAH" to Currency(code = "UAH", emoji = "🇺🇦",                       aliases = arrayOf("₴", "grn", "гривна", "гривен", "грн", "Ukraine", "Украина")),
        "PLN" to Currency(code = "PLN", emoji = "🇵🇱",                       aliases = arrayOf("zloty", "złoty", "злотый", "PLZ", "Poland", "Польша")),
        "CZK" to Currency(code = "CZK", emoji = "🇨🇿",                       aliases = arrayOf("kč", "kc", "krn", "крона", "крн", "кц", "Czech", "Чехия",)),
        "GBP" to Currency(code = "GBP", emoji = "🇬🇧",                       aliases = arrayOf("£", "pound", "pnd", "pd", "фунт", "фнт", "UKL", "England", "Britain", "Англии", "Британия")),
        "JPY" to Currency(code = "JPY", emoji = "🇯🇵",                       aliases = arrayOf("¥", "yens", "йена", "Japan", "Япония")),
        "CNY" to Currency(code = "CNY", emoji = "🇨🇳",                       aliases = arrayOf("Ұ", "yuan", "юань", "China", "Китай")),
        ...
        "KZT" to Currency(code = "KZT", emoji = "🇰🇿",                       aliases = arrayOf("tenge", "тенге", "тнг", "Kazakhstan", "Казахстан")),
        "KGS" to Currency(code = "KGS", emoji = "\uD83C\uDDF0\uD83C\uDDEC", aliases = arrayOf("som", "сом", "Kyrgyzstan", "Кыргызстан")),
        "ILS" to Currency(code = "ILS", emoji = "\uD83C\uDDEE\uD83C\uDDF1", aliases = arrayOf("shekel", "шекель", "Israel", "Израиль")),

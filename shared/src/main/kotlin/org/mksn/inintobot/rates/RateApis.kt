...
object RateApis {
    val ALL = mapOf(
        ...
        "Fixer" to RateApi(
            name = "Fixer",
            base = Currencies.forCode("EUR"),
            url = "http://data.fixer.io/api/latest?access_key=<fixer_access_key>&symbols=BYN,USD,EUR,RUB,UAH,PLN,CZK,GBP,JPY,CNY,KZT,CHF,BGN,TRY,CAD,ISK,DKK,SEK,NOK,BTC,ILS,GEL,HUF,MXN,HRK,VND,KRW,MDL,HKD,RON,IDR,INR,THB,AMD,KGS,AUD,AED",
        ...
        "OpenExchangeRates" to RateApi(
            ...
            url = "https://openexchangerates.org/api/latest.json?app_id=<openexchangerates_access_key>&symbols=BYN,USD,EUR,RUB,UAH,PLN,CZK,GBP,JPY,CNY,KZT,CHF,BGN,TRY,CAD,ISK,DKK,SEK,NOK,BTC,ILS,GEL,HUF,MXN,HRK,VND,KRW,MDL,HKD,RON,IDR,INR,THB,AMD,KGS,AUD,AED",
        ...
        "TraderMade" to RateApi(
            name = "TraderMade",
            base = Currencies.forCode("USD"),
            url = "https://marketdata.tradermade.com/api/v1/live?api_key=<tradermade_access_key>&currency=USDEUR,USDRUB,USDPLN,USDCZK,USDGBP,USDJPY,USDCNY,USDCHF,USDTRY,USDCAD,USDISK,USDDKK,USDSEK,USDNOK,USDILS,USDBTC,USDETH,USDHUF,USDTHB,USDIDR,USDINR,USDRON,USDHKD,USDKRW,USDVND,USDHRK,USDMXN,USDAUD,USDAED",

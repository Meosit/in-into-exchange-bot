...
object RateApis : Iterable<RateApi> {
    private val ALL = mapOf(
        ...
        "Fixer" to RateApi(
            ...
            url = "http://data.fixer.io/api/latest?access_key=${System.getenv("FIXER_ACCESS_KEY")}&symbols=BYN,USD,EUR,RUB,UAH,PLN,CZK,GBP,JPY,CNY,KZT,CHF,BGN,TRY,CAD,ISK,DKK,SEK,NOK,BTC,ILS,GEL,HUF,MXN,HRK,VND,KRW,MDL,HKD,RON,IDR,INR,THB,AMD,UZS,KGS,AUD,AED,BRL",
            displayLink = "https://fixer.io/",
            unsupported = setOf("ETH"),
            refreshHours = 8,
            backFillInfo = RateApiBackFillInfo(
                url = "http://data.fixer.io/api/<date>?access_key=${System.getenv("FIXER_ACCESS_KEY")}&symbols=BYN,USD,EUR,RUB,UAH,PLN,CZK,GBP,JPY,CNY,KZT,CHF,BGN,TRY,CAD,ISK,DKK,SEK,NOK,BTC,ILS,GEL,HUF,MXN,HRK,VND,KRW,MDL,HKD,RON,IDR,INR,THB,AMD,UZS,KGS,AUD,AED,BRL",
                backFillLimit = LocalDate.of(2020, 1, 1),
            )
        ),
        "OpenExchangeRates" to RateApi(
            ...
            base = Currencies["USD"],
            aliases = arrayOf("OER"),
            url = "https://openexchangerates.org/api/latest.json?app_id=${System.getenv("OPENEXCHANGERATES_ACCESS_KEY")}&symbols=BYN,USD,EUR,RUB,UAH,PLN,CZK,GBP,JPY,CNY,KZT,CHF,BGN,TRY,CAD,ISK,DKK,SEK,NOK,BTC,ILS,GEL,HUF,MXN,HRK,VND,KRW,MDL,HKD,RON,IDR,INR,THB,AMD,UZS,KGS,AUD,AED,BRL",
            displayLink = "https://openexchangerates.org/",
            unsupported = setOf("ETH"),
            refreshHours = 1,
            backFillInfo = RateApiBackFillInfo(
                url = "https://openexchangerates.org/api/historical/<date>.json?app_id=${System.getenv("OPENEXCHANGERATES_ACCESS_KEY")}&symbols=BYN,USD,EUR,RUB,UAH,PLN,CZK,GBP,JPY,CNY,KZT,CHF,BGN,TRY,CAD,ISK,DKK,SEK,NOK,BTC,ILS,GEL,HUF,MXN,HRK,VND,KRW,MDL,HKD,RON,IDR,INR,THB,AMD,UZS,KGS,AUD,AED,BRL",
                backFillLimit = LocalDate.of(2020, 1, 1),
            ),
        ),
